...
public class MetadataNotification extends VersionedData implements HasIdentifier
{
    ...
    @EqualsExclude
    @JsonProperty
    private Map<Integer, MetadataNotificationResponse> responses;
    @JsonProperty
    ...
    public MetadataNotification(@JsonProperty(value = "projectId") String projectId,
                                ...
                                @JsonProperty(value = "responses") Map<Integer, MetadataNotificationResponse> responses,
    ...
    public Map<Integer, MetadataNotificationResponse> getResponses()
    {
        if (responses == null)
        {
    ...
    public void setResponses(Map<Integer, MetadataNotificationResponse> responses)
    {
