...
public interface ManageQueryMetrics
{
    ...
    Optional<VersionQuerySummary> getSummary(String groupId,String artifactId,String versionId);

    List<VersionQuerySummary> getSummaryByProjectVersion();
