...
public class VersionValidator
{
    ...
    public static final String VALID_VERSION_ID_TXT = "a valid version string: x.y.z, master-SNAPSHOT or alias: latest = last released version, head = latest unrelased revision";
