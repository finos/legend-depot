...
class StoredVersionedEntityDataClaudeTest
...

{
    ...
    void testFiveArgConstructorWithAllValidValues()
  {
        ...
        StoredVersionedEntityData entity = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", entityDef, attributes);
    ...
    void testFiveArgConstructorWithNullEntity()
  {
        ...
        StoredVersionedEntityData entity = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", null, attributes);
    ...
    void testFiveArgConstructorWithNullAttributes()
  {
        ...
        StoredVersionedEntityData entity = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", entityDef, null);
    ...
    void testFiveArgConstructorWithNullGroupId()
  {
        ...
        StoredVersionedEntityData entity = new StoredVersionedEntityData(null, "artifactId", "1.0.0", entityDef, new HashMap<>());
    ...
    void testFiveArgConstructorWithNullArtifactId()
  {
        ...
        StoredVersionedEntityData entity = new StoredVersionedEntityData("groupId", null, "1.0.0", entityDef, new HashMap<>());
    ...
    void testFiveArgConstructorWithNullVersionId()
  {
        ...
        StoredVersionedEntityData entity = new StoredVersionedEntityData("groupId", "artifactId", null, entityDef, new HashMap<>());
  ...
  {
        StoredVersionedEntityData entity = new StoredVersionedEntityData(null, null, null, null, null);
  ...
  {
        StoredVersionedEntityData entity = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0");
  ...
  {
        StoredVersionedEntityData entity = new StoredVersionedEntityData(null, null, null);
  ...
  {
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0");
        assertEquals("", entity1.getId());

        EntityDefinition entityDef = new EntityDefinition("test.path", "classifier.path", new HashMap<>());
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", entityDef, new HashMap<>());
  ...
  {
        EntityDefinition entityDef = new EntityDefinition("test.path", "classifier.path", new HashMap<>());
        StoredVersionedEntityData entity = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", entityDef, new HashMap<>());
  ...
  {
        StoredVersionedEntityData entity = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", null, new HashMap<>());
        assertNull(entity.getEntity());
    }
  ...
  {
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0");
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0");
    ...
    void testEqualsWithEqualInstancesFiveArgConstructor()
  {
        ...
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", entityDef1, attributes1);
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", entityDef2, attributes2);
  ...
  {
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId1", "artifactId", "1.0.0");
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId2", "artifactId", "1.0.0");
  ...
  {
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId", "artifactId1", "1.0.0");
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId", "artifactId2", "1.0.0");
  ...
  {
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0");
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId", "artifactId", "2.0.0");
    ...
    void testEqualsWithDifferentEntity()
  {
        ...
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", entityDef1, new HashMap<>());
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", entityDef2, new HashMap<>());
    ...
    void testEqualsWithDifferentAttributes()
  {
        ...
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", null, attributes1);
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", null, attributes2);
    ...
    void testEqualsWithOneNullEntity()
  {
        ...
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", entityDef, new HashMap<>());
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", null, new HashMap<>());
  ...
  {
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0", null, new HashMap<>());
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0");
  ...
  {
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData(null, null, null, null, null);
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData(null, null, null, null, null);
    ...
    void testEqualsTransitivity()
  {
        StoredVersionedEntityData entity1 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0");
        StoredVersionedEntityData entity2 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0");
        StoredVersionedEntityData entity3 = new StoredVersionedEntityData("groupId", "artifactId", "1.0.0");
