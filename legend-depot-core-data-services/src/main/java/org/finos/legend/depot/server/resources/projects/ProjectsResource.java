...
public class ProjectsResource extends TracingResource
{
    ...
    {
        return handle(ResourceLoggingAndTracing.GET_ALL_PROJECTS, () -> projectApi.getAllProjectCoordinates(), null, () -> null);
    }
    ...
    {
        return handle(ResourceLoggingAndTracing.GET_PROJECT_CONFIG_BY_GA, () -> projectApi.findCoordinates(groupId, artifactId), null, () -> null);
    }
    ...
    {
        return handle(ResourceLoggingAndTracing.GET_VERSIONS, () -> projectApi.getVersions(groupId, artifactId,includeSnapshots), null, () -> null);
    }
