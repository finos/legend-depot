...
public class MongoStoreMigrationsResource extends BaseAuthorisedResource
{

    public static final String STORE_ADMINISTRATION_RESOURCE = "Store Administration";
    private final MongoMigrations mongoMigrations;


    @Inject
    protected MongoStoreMigrationsResource(MongoMigrations mongoMigrations,
