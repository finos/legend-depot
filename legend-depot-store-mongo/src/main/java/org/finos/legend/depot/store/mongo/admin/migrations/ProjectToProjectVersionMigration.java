    ...
    public void migrationToProjectVersions()
    {
        ...
        projectCollection.find().forEach((Consumer<Document>) document ->
        {
            ...
            try
            {
                ...
                versionCollection.insertOne(buildDocument(createStoreProjectData(document, "master-SNAPSHOT")));
                LOGGER.info(String.format("%s-%s-%s insertion completed",groupId,artifactId, "master-SNAPSHOT"));
