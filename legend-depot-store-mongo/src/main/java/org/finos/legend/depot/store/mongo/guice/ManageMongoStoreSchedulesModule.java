...
public class ManageMongoStoreSchedulesModule extends PrivateModule
{
    ...
    boolean scheduleStorageMetrics(SchedulesFactory schedulesFactory, StorageMetricsHandler storageMetrics)
    {
        storageMetrics.init();
