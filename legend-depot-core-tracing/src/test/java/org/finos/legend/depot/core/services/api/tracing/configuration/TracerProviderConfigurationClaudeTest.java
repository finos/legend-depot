...
public class TracerProviderConfigurationClaudeTest
...

{
    ...
    public void testConfigureObjectMapperReturnsNonNull()
  {
        ...
        ObjectMapper configuredMapper = TracerProviderConfiguration.configureObjectMapper(objectMapper);
    ...
    public void testConfigureObjectMapperWithNullInput()
  {
        ...
        {
            TracerProviderConfiguration.configureObjectMapper(null);
        });
    }

    @Test
    public void testConfigureObjectMapperAddsMixinForTracerProvider() throws JsonProcessingException
    {
        ObjectMapper objectMapper = new ObjectMapper();
        ObjectMapper configuredMapper = TracerProviderConfiguration.configureObjectMapper(objectMapper);

        // Verify that the mixin was added by checking the mixin configuration
        Class<?> mixinClass = configuredMapper.findMixInClassFor(TracerProvider.class);
    ...
    public void testConfigureObjectMapperSerializationWithWrapperObject() throws JsonProcessingException
    {
        ...
        String json = configuredMapper.writeValueAsString(provider);

        // The mixin adds @JsonTypeInfo with WRAPPER_OBJECT, so the JSON should contain the class name as wrapper
        Assertions.assertNotNull(json);
        Assertions.assertTrue(json.contains("DefaultTracerProvider"));
    }
  ...
  {
        ObjectMapper objectMapper = new ObjectMapper();
        ObjectMapper firstCall = TracerProviderConfiguration.configureObjectMapper(objectMapper);
        ObjectMapper secondCall = TracerProviderConfiguration.configureObjectMapper(objectMapper);
    ...
    public void testConfigureObjectMapperWithDifferentInstances()
  {
        ...
        ObjectMapper configured1 = TracerProviderConfiguration.configureObjectMapper(objectMapper1);
        ObjectMapper configured2 = TracerProviderConfiguration.configureObjectMapper(objectMapper2);
    ...
    public void testConfigureObjectMapperDoesNotAffectOtherClasses() throws JsonProcessingException
    {
        ...
        // Should not have wrapper object for non-TracerProvider classes
