...
public class StoredVersionedEntityData extends StoredVersionedEntity
{
    @JsonProperty
    private EntityDefinition entity;

    @JsonCreator
    public StoredVersionedEntityData(@JsonProperty(value = "groupId") String groupId,
    ...
    public StoredVersionedEntityData(String groupId, String artifactId, String versionId)
    {
